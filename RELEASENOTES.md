...
* [GH-686](https://github.com/apache/cordova-plugin-camera-android/pull/686) chore(android): add missing apache license header
* [GH-685](https://github.com/apache/cordova-plugin-camera-android/pull/685) fix(ios): correctly append exif on **iOS** 14
* [GH-669](https://github.com/apache/cordova-plugin-camera-android/pull/669) fix(android): save to photo gallery - fixes issues [#341](https://github.com/apache/cordova-plugin-camera-android/pull/341) & [#577](https://github.com/apache/cordova-plugin-camera-android/pull/577)
* [GH-672](https://github.com/apache/cordova-plugin-camera-android/pull/672) chore: Fix JIRA links in RELEASENOTES.md
* [GH-664](https://github.com/apache/cordova-plugin-camera-android/pull/664) chore: Update RELEASENOTES

### 5.0.0 (Sep 14, 2020)

* [GH-648](https://github.com/apache/cordova-plugin-camera-android/pull/648) ci(travis): update osx xcode image
* [GH-637](https://github.com/apache/cordova-plugin-camera-android/pull/637) breaking: remove `NATIVE_URI` DestinationType
* [GH-628](https://github.com/apache/cordova-plugin-camera-android/pull/628) breaking: bump project requirements
* [GH-634](https://github.com/apache/cordova-plugin-camera-android/pull/634) chore: remove deprecated `file-transfer` plugin
* [GH-632](https://github.com/apache/cordova-plugin-camera-android/pull/632) fix(android): return error if file url is null
* [GH-510](https://github.com/apache/cordova-plugin-camera-android/pull/510) fix(android): use provider prefix to avoid conflicts other plugin providers
* [GH-617](https://github.com/apache/cordova-plugin-camera-android/pull/617) breaking(android): stop using `CordovaUri` helper class
* [GH-630](https://github.com/apache/cordova-plugin-camera-android/pull/630) chore: add `package-lock.json`
* [GH-631](https://github.com/apache/cordova-plugin-camera-android/pull/631) chore(package): use short notation
* [GH-629](https://github.com/apache/cordova-plugin-camera-android/pull/629) feat: migrate to `@cordova/eslint-config@3.x`
* [GH-626](https://github.com/apache/cordova-plugin-camera-android/pull/626) ci: fix additional tests
* [GH-627](https://github.com/apache/cordova-plugin-camera-android/pull/627) breaking: bump version 5.0.0-dev
* [GH-612](https://github.com/apache/cordova-plugin-camera-android/pull/612) fix(ios): `tempFilePath` called twice if using `CameraUsesGeolocation`
* [GH-588](https://github.com/apache/cordova-plugin-camera-android/pull/588) Cache images in device storage, devices have enough space now.
* [GH-508](https://github.com/apache/cordova-plugin-camera-android/pull/508) docs(readme): app renamed to Google Photos
* chore(asf): update git notification settings
* [GH-580](https://github.com/apache/cordova-plugin-camera-android/pull/580) fix(ios): return copy of video when picking from gallery on **iOS** 13
* Update CONTRIBUTING.md
* [GH-551](https://github.com/apache/cordova-plugin-camera-android/pull/551) Fix UI API called on a background thread
* [GH-576](https://github.com/apache/cordova-plugin-camera-android/pull/576) ci: updates Node.js versions
* [GH-575](https://github.com/apache/cordova-plugin-camera-android/pull/575) chore(npm): adds ignore list 
* [GH-513](https://github.com/apache/cordova-plugin-camera-android/pull/513) docs(README): remove confusing comment
* [GH-512](https://github.com/apache/cordova-plugin-camera-android/pull/512) docs(README): remove orphan **Windows** phone 7 note
* [GH-306](https://github.com/apache/cordova-plugin-camera-android/pull/306) ImagePicker returning same image

### 4.1.0 (Jun 27, 2019)

-   docs: remove outdated test docs translations ([`06dc38f`](https://github.com/apache/cordova-plugin-camera-android/commit/06dc38f))
-   build: remove `.ratignore` file that is not needed any more ([`5dc9527`](https://github.com/apache/cordova-plugin-camera-android/commit/5dc9527))
-   chore: fix repo and issue urls and license in package.json and plugin.xml ([`cad8bd1`](https://github.com/apache/cordova-plugin-camera-android/commit/cad8bd1))
-   fix: temporarily remove Appium tests to unbreak CI ([#468](https://github.com/apache/cordova-plugin-camera-android/issues/468)) ([`19d8e2f`](https://github.com/apache/cordova-plugin-camera-android/commit/19d8e2f))
-   ci(travis): Update Travis CI configuration for new paramedic ([#455](https://github.com/apache/cordova-plugin-camera-android/issues/455)) ([`cffd0ac`](https://github.com/apache/cordova-plugin-camera-android/commit/cffd0ac))
-   fix(android): Fix NullPointerException error on some Android phones ([#429](https://github.com/apache/cordova-plugin-camera-android/issues/429)) ([`295e928`](https://github.com/apache/cordova-plugin-camera-android/commit/295e928))
-   ci: Update CI Environment Setup for Node.js 6 ([#438](https://github.com/apache/cordova-plugin-camera-android/issues/438)) ([`fae190e`](https://github.com/apache/cordova-plugin-camera-android/commit/fae190e))
-   refactor(android): Enhancement: Camera plugin code cleanup ([#425](https://github.com/apache/cordova-plugin-camera-android/issues/425)) ([`a13665d`](https://github.com/apache/cordova-plugin-camera-android/commit/a13665d))
-   fix(android): Exif data lost on many cases ([#331](https://github.com/apache/cordova-plugin-camera-android/issues/331)) ([`81b878d`](https://github.com/apache/cordova-plugin-camera-android/commit/81b878d))
-   chore(github): Add or update GitHub pull request and issue template ([`b261d31`](https://github.com/apache/cordova-plugin-camera-android/commit/b261d31))
-   fix(ios): fixes UIImagePickerController cancel handling for iOS11+ ([#377](https://github.com/apache/cordova-plugin-camera-android/issues/377)) ([`24c8b6c`](https://github.com/apache/cordova-plugin-camera-android/commit/24c8b6c))
-   docs: Remove deprecated platforms from docs ([#394](https://github.com/apache/cordova-plugin-camera-android/issues/394)) ([`7ddb3df`](https://github.com/apache/cordova-plugin-camera-android/commit/7ddb3df))
-   fix(android): return DATA_URL for ALLMEDIA if it's an image ([#382](https://github.com/apache/cordova-plugin-camera-android/issues/382)) ([`60e7795`](https://github.com/apache/cordova-plugin-camera-android/commit/60e7795))
-   refactor(ios): [CB-13813](https://issues.apache.org/jira/browse/CB-13813): Remove old iOS code ([#381](https://github.com/apache/cordova-plugin-camera-android/issues/381)) ([`ce77aab`](https://github.com/apache/cordova-plugin-camera-android/commit/ce77aab))
-   feat(ios): [CB-13865](https://issues.apache.org/jira/browse/CB-13865): (Ipad) Making popover Window Size configurable using popoverOptions - imagePicker ([#314](https://github.com/apache/cordova-plugin-camera-android/issues/314)) ([`cd72047`](https://github.com/apache/cordova-plugin-camera-android/commit/cd72047))
-   chore(types): [CB-13837](https://issues.apache.org/jira/browse/CB-13837): fix TypeScript Definition for CameraPopoverOptions ([#379](https://github.com/apache/cordova-plugin-camera-android/issues/379)) ([`86b0bf2`](https://github.com/apache/cordova-plugin-camera-android/commit/86b0bf2))
-   docs(android): clarify android quirk of cameraDirection ([`a5a3d88`](https://github.com/apache/cordova-plugin-camera-android/commit/a5a3d88), [`bfbe4a1`](https://github.com/apache/cordova-plugin-camera-android/commit/bfbe4a1))
-   chore(release): Bump minor version ([#370](https://github.com/apache/cordova-plugin-camera-android/issues/370)) ([`eed4433`](https://github.com/apache/cordova-plugin-camera-android/commit/eed4433))
-   build: Remove automatic README generation ([#365](https://github.com/apache/cordova-plugin-camera-android/issues/365)) ([`07e8574`](https://github.com/apache/cordova-plugin-camera-android/commit/07e8574))
-   docs: remove JIRA link ([`bcb26fb`](https://github.com/apache/cordova-plugin-camera-android/commit/bcb26fb))
-   ci(travis): also accept terms for android sdk `android-27` ([`a346212`](https://github.com/apache/cordova-plugin-camera-android/commit/a346212))
-   docs: remove outdated docs translations that haven't been touched for 3 years ([`403682b`](https://github.com/apache/cordova-plugin-camera-android/commit/403682b))
-   fix(android): [CB-14097](https://issues.apache.org/jira/browse/CB-14097): Fix crash when selecting some files with getPicture ([#322](https://github.com/apache/cordova-plugin-camera-android/issues/322)) ([`5c23b65`](https://github.com/apache/cordova-plugin-camera-android/commit/5c23b65))
-   fix(browser): [CB-13384](https://issues.apache.org/jira/browse/CB-13384): Added deprecation of video.src compatibility ([#288](https://github.com/apache/cordova-plugin-camera-android/issues/288)) ([`5163d38`](https://github.com/apache/cordova-plugin-camera-android/commit/5163d38))
-   fix(browser): Remove audio flag from getUserMedia ([#284](https://github.com/apache/cordova-plugin-camera-android/issues/284)) ([`36343a8`](https://github.com/apache/cordova-plugin-camera-android/commit/36343a8))
-   docs: replace warning emoji with warning unicode ([#317](https://github.com/apache/cordova-plugin-camera-android/issues/317)) ([`ead7d5e`](https://github.com/apache/cordova-plugin-camera-android/commit/ead7d5e))
-   feat(android): Update engines to use variables ([#323](https://github.com/apache/cordova-plugin-camera-android/issues/323)) ([`6899c5e`](https://github.com/apache/cordova-plugin-camera-android/commit/6899c5e))
-   feat(android): [CB-14017](https://issues.apache.org/jira/browse/CB-14017): Make com.android.support:support-v4 version configurable ([#318](https://github.com/apache/cordova-plugin-camera-android/issues/318)) ([`e334656`](https://github.com/apache/cordova-plugin-camera-android/commit/e334656))
-   refactor(android): [CB-14047](https://issues.apache.org/jira/browse/CB-14047): CameraLauncher: Replacing Repeated String literals with final variables ([#319](https://github.com/apache/cordova-plugin-camera-android/issues/319)) ([`5ec121b`](https://github.com/apache/cordova-plugin-camera-android/commit/5ec121b))
-   fix(windows): [CB-11714](https://issues.apache.org/jira/browse/CB-11714): added extra check for content-type in savePhoto() without options.targetWidth/Height ([#242](https://github.com/apache/cordova-plugin-camera-android/issues/242)) ([`a201722`](https://github.com/apache/cordova-plugin-camera-android/commit/a201722), [`dc73954`](https://github.com/apache/cordova-plugin-camera-android/commit/dc73954), [`dca4b9c`](https://github.com/apache/cordova-plugin-camera-android/commit/dca4b9c), [`c1b9772`](https://github.com/apache/cordova-plugin-camera-android/commit/c1b9772), [`eb57b02`](https://github.com/apache/cordova-plugin-camera-android/commit/eb57b02))
...
* [CB-12236](https://issues.apache.org/jira/browse/CB-12236) - Fixed RELEASENOTES for cordova-plugin-camera-android
...
* [CB-9128](https://issues.apache.org/jira/browse/CB-9128) cordova-plugin-camera-android documentation translation: cordova-plugin-camera-android
...
* [CB-8683](https://issues.apache.org/jira/browse/CB-8683) updated blackberry specific references of org.apache.cordova.camera to cordova-plugin-camera-android
...
* [CB-8438](https://issues.apache.org/jira/browse/CB-8438) cordova-plugin-camera-android documentation translation: cordova-plugin-camera-android
...
* [CB-7700](https://issues.apache.org/jira/browse/CB-7700) cordova-plugin-camera-android documentation translation: cordova-plugin-camera-android
...
* [CB-7471](https://issues.apache.org/jira/browse/CB-7471) cordova-plugin-camera-android documentation translation: cordova-plugin-camera-android
...
* [CB-7249](https://issues.apache.org/jira/browse/CB-7249) cordova-plugin-camera-android documentation translation: cordova-plugin-camera-android
...
* documentation translation: cordova-plugin-camera-android
